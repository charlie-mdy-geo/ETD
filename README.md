...
- To study how theses can be modified in real project.</br>
- To save time for searching via the internet. </br>
- To help students be better preparaed as knowledge workers </br>
- To gain data easily from this project. </br>
- To learn about electronic document preparation and digital libraries.</br>
# Scope of Proposed System</br>
The proposed project of Electronic  Thesis and Dissertation is prescribed as follow; </br>
- View Home </br>
- View Author </br>
- View Bachelor </br>
- View Year </br>
...
- No need to print copy and bind paper thesis; digital copies are much cheaper to produce than traditional paper bound versions </br>
- Do not need storage space in libraries </br>
- Students learn about thesis and document preparation </br>
# Disadvantanges </br>
